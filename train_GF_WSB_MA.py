...
from models import GroupFreeDetector, get_loss, get_loss_weak
...
def parse_option():
    ...
    parser.add_argument('--num_decoder_layers', default=2, type=int, help='number of decoder layers')
...
def get_loader(args):
    ...
    if args.dataset == 'scannet':
        ...
        data_path = 'matterport_train_detection_data_md40' 
            
        DATASET_CONFIG = MatterportDatasetConfig_md40()
        TRAIN_DATASET = MatterportDetectionDataset('train', 'matterport_train_detection_data_md40', num_points=args.num_point,
                                                augment=True, center_jitter=args.center_jitter,
                                                use_color=True if args.use_color else False,
                                                use_height=True if args.use_height else False)
        TEST_DATASET = MatterportDetectionDataset('val', 'matterport_train_detection_data_md40', num_points=args.num_point,
                                               augment=False,
                                               use_color=True if args.use_color else False,
                                               use_height=True if args.use_height else False)                                            
    else:
